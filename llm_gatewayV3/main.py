...
DEFAULT_ORDER = ["ollama", "gemini", "cerebras","groq", "openrouter", "github", "nvidia"]
...
TIER_TO_ORDER = {
    "TINY":  ["github", "openrouter", "groq", "cerebras", "gemini", "ollama", "nvidia"],
    "LARGE": ["gemini", "groq", "cerebras", "github", "openrouter", "ollama", "nvidia"],
}
